...
$chave = $_POST['txt_chave'];
$patrimonio = $_POST['txt_patrimonio'];

$result_rack = "INSERT INTO rack(nome, local, bloco, chave, patrimonio) VALUES ('$nome', '$local', '$bloco', '$chave', '$patrimonio')";
$resultado = mysqli_query($conn, $result_rack);
?>
<html>
<!DOCTYPE html>
...
<body>
    <div class="main" id="main">
        <div class="header">
            ...
            <div id="box_cad">
                <?php
                echo "<br><br><div align=center><font face=Arial size=2>Rack cadastrado com Sucesso!
