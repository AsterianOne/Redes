...
function confirmSubmit() {
    var agree = confirm("Gentileza desvincular TODOS os switches, voice e patch panel antes de continuar! Tem certeza que deseja deletar esse RACK?");
    if (agree)
        return true;
    else
        return false;
...
<body>
    <div class="main" id="main">
        <div class="header">
            ...
            <div class="box_titulo">
                ...
                <a href="../login/principal_adm.php"><button class="butao" style="width: 70px">Principal</button></a>
                        <a href="./cad_rack.php"><button class="butao">Cadastrar</button></a>
                    <tr>
                        <h1 style="color:fff; padding: 8px 0 8px 0">Gerenciamento de Racks</h1>
                    </tr>
                </div>
                <script>
        ...
        <div id="conteudo_tabela">
            ...
            <p style="text-align: center;"><a href="cad_rack.php">Nenhum dado casdastrado!!</a></p>
            <?php } // Show if recordset empty ?>

            <?php if ($totalRows_Recordset1 > 0) { // Show if recordset not empty ?>

            <table class="tabela" width="586" border="0" bordercolor="#444" align="center" cellpadding="0"
                cellspacing="0">
                <tr class="main_tr" style="background-color: #384d61;">
                    ...
                    <td width="8%">
                        <h2 class="h2_t">Sigla Local</h2>
                    </td>
                    <td width="25%">
                        <h2 class="h2_t">Local</h2>
                    </td>
                    <td width="7%">
                        <h2 class="h2_t">Bloco</h2>
                    </td>
                    <td width="7%">
                        <h2 class="h2_t">Chave</h2>
                    </td>
                    <td width="10%">
                        <h2 class="h2_t">Patrimonio</h2>
                    </td>
                    <td width="8%">
                ...
                <?php do { 
        $localAtual = $row_Recordset1['local'];
...
?>
                <tr style="background-color: #;">
                    <td style="font-weight: bold;">
                        <div><?php echo $row_Recordset1['cod_rack']; ?></div>
                    </td>
                    <td>
                        <div><?php echo $row_Recordset1['nome']; ?></div>
                    </td>
                    <td>
                        <div><?php echo $row_setor['sigla']; ?></div>
                    </td>
                    <td>
                        <div><?php echo $row_setor['setor']; ?></div>
                    </td>
                    <td>
                        <div><?php echo $row_Recordset1['bloco']; ?></div>
                    </td>
                    <td>
                        <div><?php echo $row_Recordset1['chave']; ?></div>
                    </td>
                    <td>
                        <div><?php echo $row_Recordset1['patrimonio']; ?></div>
                    </td>
                    <td align="center">
                        <a class="action"
                            href="../cad_rack/pesq_rack.php?cod_rack=<?php echo $row_Recordset1['cod_rack']; ?>"
                            onclick="NovaJanela(this.href,'album','414','924','yes');return false"><img
                                src="../img/rack.png" alt="Acessar Rack"></a>
                        <a class="action"
                            href="../cad_rack/alterar_rack.php?cod_rack=<?php echo $row_Recordset1['cod_rack']; ?>"
                            onclick="NovaJanela(this.href,'album','600','300','yes');return false"><img
                                src="../img/editar.png" alt="Alterar"></a>
                        <a class="action"
                            href="../cad_rack/excluir_rack.php?cod_rack=<?php echo $row_Recordset1['cod_rack']; ?>"
                            onClick="return confirmSubmit()"><img src="../img/excluir.png" alt="Excluir"></a>
                    </td>
                </tr>
                <?php }while($row_Recordset1 = mysqli_fetch_assoc($Recordset1)); ?>
                <tr>
                    <td colspan="8" border="0px" align="center" style="background-color: #d3d3d3;">
                        <p><br>
                            Rack <b><?php echo ($startRow_Recordset1 + 1) ?></b> a
                ...
                <tr>
                    <td class="seta" idth="100%" colspan="8" align="center" style="background-color: #d3d3d3;">
