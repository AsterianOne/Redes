...
function confirmSubmit() {
    var agree = confirm("Tem certeza que deseja deletar esse Switch?");
    if (agree)
        return true;
    else
        return false;
...
<?php
  ...
  $query_Recordset1 = "SELECT * FROM switch ORDER BY cod_switch ASC";
    ...
    <div class="header">
        ...
        <div class="box_titulo">
            ...
            <a href="../login/principal_adm.php"><button class="butao" style="width: 70px">Principal</button></a>
                <a href="./cad_switch.php"><button class="butao">Cadastrar</button></a>
                <tr>
                    <h1 style="color:fff; padding: 8px 0 8px 0">Gerenciamento de Switchs</h1>
                </tr>
...
<div id="conteudo_tabela">
    ...
    <p style="text-align: center;"><a href="cad_switch.php">Nenhum dado casdastrado!!</a></p>
    <?php } // Show if recordset empty ?>

    <?php if ($totalRows_Recordset1 > 0) { // Show if recordset not empty ?>
    <table class="tabela" width="586" border="0" bordercolor="#444" align="center" cellpadding="0" cellspacing="0">
        <tr class="main_tr" style="background-color: #384d61;">
            ...
            <td width="10%">
                <h2 class="h2_t">Marca</h2>
            </td>
            <td width="10%">
                <h2 class="h2_t">Modelo</h2>
            </td>
            <td width="10%">
                <h2 class="h2_t">Serial</h2>
            </td>
            <td width="10%">
                <h2 class="h2_t">Patrimonio</h2>
            </td>
            <td width="10%">
                <h2 class="h2_t">Qtd. de Portas</h2>
            </td>
            <td width="10%">
                <h2 class="h2_t">Portas Disponiveis</h2>
            </td>
            <td width="10%">
        ...
        <?php do { 
            $cod_switch = $row_Recordset1['cod_switch'];
            $cod_rack = $row_Recordset1['rack'];

            //Contar as portas dispníveis no SWITCH
            mysqli_select_db($conn, $dbname);
        ...
        <tr style="background-color: #;">
            <td style="font-weight: bold;">
                <div><?php echo $row_Recordset1['cod_switch']; ?></div>
            </td>
            <td>
                <div><?php echo $row_Recordset1['ip']; ?></div>
            </td>
            <td>
                <div><?php echo $row_Recordset1['marca']; ?></div>
            </td>
            <td>
                <div><?php echo $row_Recordset1['modelo']; ?></div>
            </td>
            <td>
                <div><?php echo $row_Recordset1['serial']; ?></div>
            </td>
            <td>
            ...
            <td align="center">
                <a class="action"
                    href="../cad_switch/adm_switch.php?cod_switch=<?php echo $row_Recordset1['cod_switch']; ?>"
                    onclick="NovaJanela(this.href,'album','895','300','yes');return false"><img src="../img/editar.png"
                        alt="Alterar"></a>
                <a class="action"
                    href="../cad_switch/excluir_switch.php?cod_switch=<?php echo $row_Recordset1['cod_switch']; ?>"
        ...
        <tr>
            <td colspan="10" align="center" style="background-color: #d3d3d3;">
                <p><br>
                    Switch <b><?php echo ($startRow_Recordset1 + 1) ?></b> a
