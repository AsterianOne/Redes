    ...
    <div class="main" id="main">
        ...
        <div id="box_cad">
            <div class="titulo_cad">
                <h2>Cadastrar Patch Panel</h2>
            </div>
            <form method="POST" class="cad_item" action="./cad_patch2.php">
                <table class="tabela" border="0" cellpadding="0" cellspacing="3">
                    <tr height="20">
                        <td width="20%" align="right"><b>Nome:</b></td>
                        <td width="50%"><input name="txt_nome" type="text" value="" maxlength="60" style="width: 250px">
                        </td>
                    </tr>
                    <tr height="20">
                        <td width="20%" align="right"><b>Qtd. Portas:</b></td>
                        <td width="50%"><input style="width: 250px" name="txt_qtd_portas" type="number"
                                placeholder="Somente Numeros..." value="24" maxlength="60"></td>
                    </tr>
                    <tr height="20">
                        <td width="20%" align="right"><b>Etiqueta:</b></td>
                        <td width="50%"><input name="txt_etiqueta" type="text"  value="0" maxlength="60"></td>
                    </tr>
                    <tr height="20">
                        <td width="20%" align="right"><b>Rack:</b></td>
                        <td width="50%">
                            <select style="width: 250px" name="txt_rack" id="txt_rack">
                                <?php
                        do {  
                ...
                <div class="botao">
                    ...
                    <a href="./lst_patch.php"><button type="button" name="Cancelar">Cancelar</button></a>
                </div>
            </form>
        </div>
    </div>
