...
//Cadastrar Setor
    $result_setor = "INSERT INTO setores(setor, sigla) VALUES ('$setor', '$sigla')";
    $resultado = mysqli_query($conn, $result_setor);
?>
<html>
<!DOCTYPE html>
...
<body>
    <div class="main" id="main">
        <div class="header">
            ...
            <div id="box_cad">
                <?php
                echo "<br><br><div align=center><font face=Arial size=2>Setor cadastrado com Sucesso!
