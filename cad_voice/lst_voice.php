...
function confirmSubmit() {
    var agree = confirm("Tem certeza que deseja deletar esse Patch Voice?");
    if (agree) {
        return true;
    } else {
        return false;
...
<?php
//inicia sessao e conecta com o banco de dados
...
$query_Recordset1 = "SELECT * FROM voice ORDER BY cod_voice ASC";
...
<body>
    <div class="main" id="main">
            ...
            <div class="box_titulo">
                ...
                <div class="titulo_pg">
                    ...
                    <a href="../login/principal_adm.php"><button class="butao" style="width: 70px">Principal</button></a>
                        <a href="./cad_voice.php"><button class="butao">Cadastrar</button></a>
                        <h1 style="color:fff; padding: 8px 0 8px 0">Gerenciamento de Voice Panels</h1>
                    </tr>
                </div>
                <script>
        ...
        <div id="conteudo_tabela">
            ...
            <p style="text-align: center;"><a href="cad_voice.php">Nenhum dado casdastrado!!</a></p>
            ...
            <table class="tabela" border="0" bordercolor="#444" align="center" cellpadding="0" cellspacing="0">
                ...
                <?php do { 
            $cod_voice = $row_Recordset1['cod_voice'];
            ...
            ?>
                <tr style="background-color: #;">
                    ...
                    <td align="center">
                        <a class="action"
                            href="../cad_voice/adm_voice.php?cod_voice=<?php echo $row_Recordset1['cod_voice']; ?>"
                            onclick="NovaJanela(this.href,'album','895','300','yes');return false"><img
                                src="../img/editar.png" alt="Alterar"></a>
                        <a class="action"
                            href="../cad_voice/excluir_voice.php?cod_voice=<?php echo $row_Recordset1['cod_voice']; ?>"
                            onClick="return confirmSubmit()"><img src="../img/excluir.png" alt="Excluir"></a>
                    </td>
                </tr>
                <?php } while ($row_Recordset1 = mysqli_fetch_assoc($Recordset1)); ?>
                <tr>
                    <td colspan="6" align="center" style="background-color: #d3d3d3;">
                        <p><br>
                ...
                <tr>
                    <td class="seta" colspan="6" align="center" style="background-color: #d3d3d3;">
