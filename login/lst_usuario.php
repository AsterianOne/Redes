...
$query_Recordset1 = "SELECT * FROM usuario ORDER BY cod_user DESC";
...
<div class="main" id="main">
  ...
  <a href="../login/principal_adm.php"><button class="butao" style="width: 70px">Principal</button></a>
        <a href="./cad_login.php"><button class="butao">Cadastrar</button></a>
            <tr> 
...
<table class="tabela" width="586" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <td width="10%"><h2 class="h2_t"> ID</h2></td>
         <td width="20%"> <h2 class="h2_t">Nome</h2></td>
         <td width="20%"> <h2 class="h2_t">Usuário</h2></td>
         <td width="20%"> <h2 class="h2_t">Tipo de Acesso</h2></td>
         <td colspan="2"><h2 class="h2_t">A&ccedil;&atilde;o</h2></td>  
  </tr> 
  <?php do { ?>
  <tr>
  <td><div><?php echo $row_Recordset1['cod_user']; ?></div></td>
    <td><div><?php echo $row_Recordset1['nome']; ?></div></td>
    <td><div><?php echo $row_Recordset1['usuario']; ?></div></td>
    <td><div><?php echo $row_Recordset1['tipo']; ?></div></td>
     <td width="5%" align="center"><div>
         <a class="action" href="../login/alterar_login.php?cod_user=<?php echo $row_Recordset1['cod_user']; ?>" onclick="NovaJanela(this.href,'album','895','300','yes');return false"><img src="../img/editar.png" alt="Alterar" width="16" height="16"></a>
         <a class="action" href="./excluir_login.php?cod_user=<?php echo $row_Recordset1['cod_user']; ?>" onClick="return confirmSubmit()"><img src="../img/excluir.png" alt="Alterar" width="16" height="16"></a>
      </div>
      </td>
      <!-- <div>
        <td width="5%" align="center">
          <a href="../login/excluir_login.php?id=<?php echo $row_Recordset1['cod_user']; ?>"><img src="../img/excluir.png" alt="Excluir" width="16" height="16"></a>
        </td>
      </div> -->
  </tr>
...
<?php } mysqli_free_result($Recordset1); // Mostrar registros se não estiver vazio ?>
              <table class="linha_seta" width="220px" align="center">
              <tr>
                <td colspan="4" border="0px" align="center">
                  <p><br>
                  Lista de Usuarios <b><?php echo ($startRow_Recordset1 + 1) ?></b> a <b><?php echo min($startRow_Recordset1 + $maxRows_Recordset1, $totalRows_Recordset1) ?></b> de <b><?php echo $totalRows_Recordset1 ?></b> <br>
                  </p>
                </td>
              </tr>
              <tr>
                <td class="seta" idth="100%" colspan="4" align="center">
