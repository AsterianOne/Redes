...
<div class="main" id="main">
  <div class="header">
    ...
    <nav class="main_nav">
    <div class="navbar_link-toggle" style="margin-top: 60px">
...
<div id="conteudo_main"> 
    <table id="index_table" style="background-color: #c2cbd4;" border="0" align="center" cellspacing="0" bgcolor="#FFFFFF">
